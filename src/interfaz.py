...
def parseo(argument,byte1,byte2,byte3,byte4):
    switcher = {
        ...
        53: '\nStage : Instruction Fetch\nNextInstructionAddress : 0x{:0>2x}{:0>2x}{:0>2x}{:0>2x} : 0b{:0>8b}_{:0>8b}_{:0>8b}_{:0>8b}'.format(byte1,byte2,byte3,byte4,byte1,byte2,byte3,byte4),
        ...
        56: 'NextInstructionAddress : 0x{:0>2x}{:0>2x}{:0>2x}{:0>2x} : 0b{:0>8b}_{:0>8b}_{:0>8b}_{:0>8b}'.format(byte1,byte2,byte3,byte4,byte1,byte2,byte3,byte4),
        ...
        62: 'NextInstructionAddress : 0x{:0>2x}{:0>2x}{:0>2x}{:0>2x} : 0b{:0>8b}_{:0>8b}_{:0>8b}_{:0>8b}'.format(byte1,byte2,byte3,byte4,byte1,byte2,byte3,byte4),
        ...
        66: 'JL : 0x{:0>2x} PC_Sel : {:0>2x} RegF_wreg : {:0>2x} : 0b{:0>8b}_{:0>8b}_{:0>8b}_{:0>8b}'.format(byte2,byte3,byte4,byte1,byte2,byte3,byte4),
        ...
        70: 'RegF_wreg : {:0>2x} : 0b{:0>8b}_{:0>8b}_{:0>8b}_{:0>8b}'.format(byte4,byte1,byte2,byte3,byte4),
...
if (load_mode != '2'):
	print ('  ---------------------------------- PROGRAM ----------------------------------\n')
	try:
		f = open ('TEST2.txt','r') #program_addi	
		while True:
			line = f.readline()
			if not line:
